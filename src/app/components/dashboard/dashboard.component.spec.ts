...
// TODO: TomW 2018-05-21 : Instead of using the real UniversityService, use a mock of UniversityService that does not send any real HTTP requests; it should contain a getUniversities() method that returns fake, hard-coded data.
